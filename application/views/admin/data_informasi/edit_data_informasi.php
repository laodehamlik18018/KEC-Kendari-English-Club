                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php foreach ($informasi as $u) { ?>
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>Auth/Informasi/proses_edit_data_informasi">
                                ...
                                <div class="form-group-row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control" name="judul" value="<?php echo $u->judul; ?>" aria-describedby="Masukkan Email and" placeholder="isi judul informasi">
                                    </div>
                                </div>
                                <div class="form-group-row">
